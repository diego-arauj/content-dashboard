...
function postImageSrc(post: DashboardPost): string {
  ...
  if (post.media_type === "VIDEO") {
    return post.thumbnail_url ?? fallback;
  }
    ...
    <Card>
      <CardHeader className="space-y-4">
        ...
        <div className="space-y-3">
          <div>
            <p className="mb-2 text-xs font-medium text-neutral-600">Ordenar por</p>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    sortBy === key
                      ...
                      : "border-[#E5E5E5] bg-white text-neutral-700 hover:bg-[#F5F5F5]"
                  )}
                >
                  {SORT_LABELS[key]}
                </button>
          ...
          <div>
            <p className="mb-2 text-xs font-medium text-neutral-600">Formato</p>
            <div className="flex flex-wrap gap-2">
              {FORMAT_KEYS.map((key) => (
                <button
                  key={key}
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 bg-black/70 p-3 text-xs text-white opacity-0 transition group-hover:opacity-100">
                ...
                <div className="mt-1 flex justify-between">
                  ...
                  <span>Links {formatMetric(post.link_clicks)}</span>
                </div>
              </div>
            </a>
          ))}
